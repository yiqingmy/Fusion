...
int main(int argc, char* argv[]) {
	...
	//imwrite("C:\\Users\\mao_y\\Desktop\\analysis\\sized_color_fusion.jpg", up_img);
	imwrite("C:\\Users\\mao_y\\Desktop\\analysis\\Init\\DOG_fusion.jpg", result);
	////*******************************************************************************
	////imwrite("C:\\Users\\mao_y\\Desktop\\TestResult\\Proposed\\a07(glg)_fused.jpg",result);
